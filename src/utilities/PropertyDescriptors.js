...
function Getter( target, key, getter, descriptorMask ) {
    DESCRIPTOR_GETTER.enumerable    = ( descriptorMask & E ) ? true : false;
    DESCRIPTOR_GETTER.configurable  = ( descriptorMask & C ) ? true : false;
    DESCRIPTOR_GETTER.get = getter;

    Object.defineProperty( target, key, DESCRIPTOR_GETTER );
}
...
function Setter( target, key, setter, descriptorMask ) {
    DESCRIPTOR_SETTER.enumerable    = ( descriptorMask & E ) ? true : false;
    DESCRIPTOR_SETTER.configurable  = ( descriptorMask & C ) ? true : false;
    DESCRIPTOR_SETTER.set = setter;
    Object.defineProperty( target, setter, DESCRIPTOR_SETTER );
}
