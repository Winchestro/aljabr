...
const getters = {
	getCurrentVertexAtrrib : function ( )	{ return gl.getVertexAttrib( this.index, gl.CURRENT_VERTEX_ATTRIB ); },
	getBuffer : function ( )				{ return gl.getVertexAttrib( this.index, gl.VERTEX_ATTRIB_ARRAY_BUFFER_BINDING ); },
	getEnabled : function ( )				{ return gl.getVertexAttrib( this.index, gl.VERTEX_ATTRIB_ARRAY_ENABLED ); },
	getSize : function ( )					{ return gl.getVertexAttrib( this.index, gl.VERTEX_ATTRIB_ARRAY_SIZE ); },
	getStride : function ( )				{ return gl.getVertexAttrib( this.index, gl.VERTEX_ATTRIB_ARRAY_STRIDE ); },
	getNormalized : function ( )			{ return gl.getVertexAttrib( this.index, gl.VERTEX_ATTRIB_ARRAY_NORMALIZED ); },
	getType : function ( )					{ return gl.getVertexAttrib( this.index, gl.VERTEX_ATTRIB_ARRAY_TYPE ); },
	getTypeFlag : function ( )				{ return gl.flags[ this.getType ]; },
	getOffset : function ( )				{ return gl.getVertexAttribOffset( this.index, gl.VERTEX_ATTRIB_ARRAY_POINTER ); },
};

for ( let p in getters ) Object.defineProperty( AttributeLocation.prototype, p, {
	get : getters[ p ]
} );


Object.defineProperties ( AttributeLocation.prototype, {
	size : { value : 4, enumerable : true },
	offset : { value : 0, enumerable : true },
	stride : { value : 0, enumerable : true },
	type : { value : GL.FLOAT, enumerable : true },
	normalized : { value : false, enumerable : true }
});