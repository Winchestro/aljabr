...
def.Properties( WebGLUniformLocation.prototype, {
    set1f ( f ) {   gl.uniform1f( this, f ); return this; },
    set2f ( f ) {   gl.uniform2f( this, f[ 0 ], f[ 1 ] ); return this; },
    set3f ( f ) {   gl.uniform3f( this, f[ 0 ], f[ 1 ], f[ 2 ] ); return this; },
    set4f ( f ) {   gl.uniform4f( this, f[ 0 ], f[ 1 ], f[ 2 ], f[ 3 ] ); return this; },

    set1i ( i ) {   gl.uniform1i( this, i ); return this; },
    set2i ( i ) {   gl.uniform2i( this, i[ 0 ], i[ 1 ] ); return this; },
    set3i ( i ) {   gl.uniform3i( this, i[ 0 ], i[ 1 ], i[ 2 ] ); return this; },
    set4i ( i ) {   gl.uniform4i( this, i[ 0 ], i[ 1 ], i[ 2 ], i[ 3 ] ); return this; },
...
export default WebGLUniformLocation;