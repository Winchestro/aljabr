...
function main ( $$dependencies ) {
    ...
    const APP = {
        ...
        handleEvent ( event ) {
            switch ( event.type ) {
                ...
                case "wheel" :
                    ...
                    let delta = event.wheelDelta / Math.abs( event.wheelDelta ) * 10;
        ...
        initialize ( ) {
            ...
            let camera = new Camera.Perspective( .01, 1000 );
            ...
            camera.position.setValues( 0, 25, 50 );


            scene.lights.push( light );
            //scene.lights.push( pointLight );
            console.time("voronoi mesh gen")
            let voronoi = window.voronoi = new VoronoiMesh( 15000, 4 );
            ...
            voronoi.scale.setValues( 1,1,1 );

            renderMesh.triangles.material.offset.setFill( 1, 1 );
